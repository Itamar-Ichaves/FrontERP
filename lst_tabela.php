...
<div class="rows">	
                ...
                <div class="caixa">
                    <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						<span class="d-flex center-middle"><i class="far fa-list-alt mr-1"></i> Lista de tabelas </span>
						<div>
							<a href="index.php?link=15" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            <thead>
                                    <tr>
                                       ...
                                       <th align="center" width="70">Ação</th>
                                    </tr>
                            </thead>
                            <tbody>                                      
                             <tr>
                                ...
                                <td align="center"><a href="index.php?link=16" class="d-inline-block btn btn-outline-verde btn-pequeno"><i class="fas fa-edit"></i> Ação</a>   </td>
                             </tr>                  
