...
<div class="rows">	
                ...
                <div class="caixa">
                   <div class="p-2 py-1 bg-title text-light text-uppercase h4 mb-0 text-branco d-flex justify-content-space-between">
						...
						<div>
							<a href="index.php?link=5" class="btn btn-verde mx-1 d-inline-block"><i class="fas fa-plus-circle"></i> Adicionar novo</a>
                    ...
                    <table cellpadding="0" cellspacing="0" id="dataTable" width="100%">
                            ...
                            <tbody>                                      
                             <tr>
                                ...
                                <td align="center"><a href="index.php?link=13" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a></td>                                   											
                                <td align="center"><a href="index.php?link=13" class="d-inline-block btn btn-outline-verde btn-pequeno"><i class="fas fa-edit"></i> Permissões</a></td>    
                             </tr>                 
